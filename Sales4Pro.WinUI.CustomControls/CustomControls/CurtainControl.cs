...
namespace Sales4Pro.WinUI.CustomControls
{
    ...
    public sealed class CurtainControl : ContentControl
    {
        ...
        public CurtainControl()
        {
            ...
            this.DefaultStyleKey = typeof(CurtainControl);
            IsTabStop = false;
        ...
        public static readonly DependencyProperty HeaderTextProperty =
            DependencyProperty.Register("HeaderText", typeof(string), typeof(CurtainControl), new PropertyMetadata("Header"));
        ...
        public static readonly DependencyProperty BackButtonVisibilityProperty =
            DependencyProperty.Register("BackButtonVisibility", typeof(Visibility), typeof(CurtainControl), new PropertyMetadata(Visibility.Visible));
        ...
        public static readonly DependencyProperty CloseButtonVisibilityProperty =
            DependencyProperty.Register("CloseButtonVisibility", typeof(Visibility), typeof(CurtainControl), new PropertyMetadata(Visibility.Visible));
        ...
        public static readonly DependencyProperty HeaderHeightProperty =
            DependencyProperty.Register("HeaderHeight", typeof(double), typeof(CurtainControl), new PropertyMetadata((double)40.0));
