...
public sealed class HeaderedCurtainContentControl : ContentControl
{
    ...
    public HeaderedCurtainContentControl()
    {
        this.DefaultStyleKey = typeof(HeaderedCurtainContentControl);
        IsTabStop = false;
    ...
    public static readonly DependencyProperty HeaderTextProperty =
        DependencyProperty.Register("HeaderText", typeof(string), typeof(HeaderedCurtainContentControl), new PropertyMetadata("Header"));
    ...
    public static readonly DependencyProperty BackButtonVisibilityProperty =
        DependencyProperty.Register("BackButtonVisibility", typeof(Visibility), typeof(HeaderedCurtainContentControl), new PropertyMetadata(Visibility.Visible));
    ...
    public static readonly DependencyProperty CloseButtonVisibilityProperty =
        DependencyProperty.Register("CloseButtonVisibility", typeof(Visibility), typeof(HeaderedCurtainContentControl), new PropertyMetadata(Visibility.Visible));
